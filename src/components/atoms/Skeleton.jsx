    ...
    return (
        <>
            <div onClick={handleClick} className='flex justify-center'>
                <div className='border border-1 border-transparent hover:border hover:border-1 hover:border-[#57575787] flex flex-row justify-between items-center gap-5 w-[350px] bg-[#2020238f] rounded-lg cursor-pointer py-2 px-2'>
